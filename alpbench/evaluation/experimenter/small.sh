...
# Load modules
cd $PFS_FOLDER/ecai24/alpbench/evaluation/experimenter/
ml lang
ml Python/3.9.5
ml Python/3.9.5-GCCcore-10.3.0

# activate environment
source $PFS_FOLDER/ecai24/alpbench/evaluation/experimenter/alpbench_noctua/bin/activate

export PYTHONPATH="/scratch/hpc-prf-aiafs/vmargraf/ecai24:$PYTHONPATH"
...
#for i in 0; do
export SCRIPT_FILE=$PFS_FOLDER/ecai24/alpbench/evaluation/experimenter/Small.py
